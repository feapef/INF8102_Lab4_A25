...
template_filename          = "vpc.yaml"
stack_name                  = "polystudent-stack-vpc"
environment_name            = "polystudent-vpc"
...
def create_stack(client,stack_name,environment_name,template_body,role_name_arn):
...
create_stack(cf,stack_name,environment_name,template_body,role_name_arn)
print("[STEP 5] Done")
